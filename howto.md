...
首先本文是对应北京联通和北京移动所针对性撰写，其他地区和其他运营商有可能存在差异，本文可以提供参考。（主要是区别于组播数据都需要鉴权的那些，一个是服务商局端校验设备mac地址，那么对应办法就是在路由器接口中，更改为你电视盒子背面的mac地址，还有验证账户的，那就改对应协议填写对应的账号和密码。这里我自己没有用过，仅抛砖引玉提供思路，其实说来说去套路就这么些，总能绕过去的）
